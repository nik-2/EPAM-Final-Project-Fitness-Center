...
<head>
    ...
    <link rel="stylesheet" type="text/css" href=css/user/data.css>
...
<body class="image" onload="${changeBankCard}">
    ...
    <ul>
        <li>
            <form name="englishForm" method="GET" action="controller">
                ...
                <input type="hidden" name="page" value="/jsp/user/data.jsp"/>
...
<div class="dataContent">
    ...
    <div class="inp">
        <b><fmt:message key="label.data.bankCard"/>:</b>
        <input type="text" id="bankCard" class="dataContentInput" onchange="setNewBankCard()"
               onfocus="checkBankCard(this)"
               oninput="checkBankCard(this)"
               value="${bankCardData}" pattern="\d{4}_\d{4}_\d{4}_\d{4}" maxlength="19" readonly>
    </div>

    <div class="inp">
        <b><fmt:message key="label.data.clubBalance"/>:</b>
        <input type="text" value="${clubBalanceData}" class="dataContentInput" name="clubBalance" readonly>
    </div>
    ...
    <div class="inp">
        ...
        <input type="text" value="${subscriptionData}" class="dataContentInput" name="subscription" readonly>
    </div>
