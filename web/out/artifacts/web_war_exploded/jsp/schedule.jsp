...
<head>
    ...
    <title><fmt:message key="label.schedule.title"/></title>
</head>
<body class="image">
<div id="sidebar">
    ...
    <ul>
        <li>
            <form name="englishForm" method="GET" action="controller">
                ...
                <input type="hidden" name="page" value="/jsp/schedule.jsp"/>
...
<div id="schedule">
    <ul>
        <li><fmt:message key="label.schedule.li1"/></li>
        <li><fmt:message key="label.schedule.li2"/></li>
        <li><fmt:message key="label.schedule.li3"/></li>
        <li><fmt:message key="label.schedule.li4"/></li>
    </ul>
</div>
</body>
</html>
