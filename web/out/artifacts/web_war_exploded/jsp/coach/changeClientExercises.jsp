...
<head>
    ...
    <title><fmt:message key="label.coach.prescribeExercise"/></title>
    ...
    <ul>
        <li>
            <form name="englishForm" method="GET" action="controller">
                ...
                <input type="hidden" name="page" value="/jsp/coach/changeClientExercises.jsp"/>
...
<h2><fmt:message key="label.coach.prescribeExercise"/></h2>
...
<div class="scroll-table">
    <table id="myTable">
        ...
        <c:forEach items="${listResults}" var="cell">
            <tr class="" onclick="setSelectMailCoach(this)">
                <td>
...
<div id="change" class="modalConfirm">
    <div class="dataContent">
        ...
        <form onsubmit="return checkValidation(document.getElementById('exercise'))" class="responseBtn" name="confirm" method="POST" action="controller">
            <input type="hidden" id="newExercise" name="exercise" value=""/>
            <input id="mail" type="hidden" name="clientMail" value=""/>
            <button onclick="setNewExercise()" type="submit" class="confirmbtn" name="command" value="change-user-exercise"><fmt:message key="label.start.confirm"/></button>
        </form>

        <div class="inp">
        <textarea type="text" class="dataContentInput" onchange="setNewExercise()" oninput="checkDietAndExer(this)" onfocus="checkDietAndExer(this)"
                  id="exercise" cols="100" rows="6" maxlength="600"></textarea>
        </div>
    </div>
</div>
</body>
