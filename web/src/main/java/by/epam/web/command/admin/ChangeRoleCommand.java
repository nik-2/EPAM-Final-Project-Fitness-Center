...
public class ChangeRoleCommand implements ActionCommand {
    ...
    public Router execute(HttpServletRequest request) {
        logger.debug("Start change role command");
        HttpSession session = request.getSession();
        session.setAttribute(StringConst.PARAM_NAME_CHANGE,StringConst.PARAM_NAME_ROLE);
        ...
        try {
            ...
            logger.error("Trouble with change role command", e);
