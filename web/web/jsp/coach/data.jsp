...
<head>
    ...
    <link rel="stylesheet" type="text/css" href=css/coach/data.css>
    ...
    <ul>
        <li>
            <form name="englishForm" method="GET" action="controller">
                ...
                <input type="hidden" name="page" value="/jsp/coach/data.jsp"/>
...
<div class="dataContent">
    ...
    <div class="inp">
        ...
        <input type="text" class="dataContentInput" onchange="setNewName()" onfocus="checkName(this)" oninput="checkName(this)"
    ...
    <div class="inp">
        ...
        <input type="text" value="${roleData}" class="dataContentInput" name="role" maxlength="5" readonly>
    </div>

    <div class="inp">
        <b><fmt:message key="label.table.dateOfReg"/>:</b>
        <input type="text" value="${dateOfReg}" class="dataContentInput" name="data-reg" maxlength="30" readonly>
    </div>
